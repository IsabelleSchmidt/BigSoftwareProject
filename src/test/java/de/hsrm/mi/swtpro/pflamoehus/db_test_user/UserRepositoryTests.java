...
public class UserRepositoryTests {
    ...
    @Autowired private BankcardRepository bankRepo;
    @Autowired private AdressRepository adressRepo;
    ...
    public void userRepo_findBy(){
        ...
        for (int i = 0; i < COUNT; i++){
            ...
            if(fund.isPresent()){
                assertThat(fund.get().toString())
                .contains(user_i.getPassword())
                .contains(user_i.getFirstName())
                .contains(user_i.getLastName())
                .contains(user_i.getEmail())
