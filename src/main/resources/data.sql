...
INSERT INTO USER(USERID,BIRTHDATE, GENDER, EMAIL,FIRSTNAME,LASTNAME,PASSWORD,VERSION) VALUES
(7,'1999-09-20','DIVERSE','user@pflamoehus.de','User','Pflamoehus','{bcrypt}$2a$10$7fdt/if1v6nJK30MExIHaeTzZ3FvkuTDikFgVxr4YW5XReorwb.HG',1),  -- UserPflamoehus1!
(1,'1976-02-28','DIVERSE', 'admin@pflamoehus.de','Admin','Pflamoehus','{bcrypt}$2a$10$aqAc7g5hfVwmZHWYE4Dw/uWUcqMuiYseKNnAIEd71PRWeWf1TYgNi',1), -- AdminPflamoehus1!
(2,'1988-06-17','DIVERSE','staff@pflamoehus.de','Staff','Pflamoehus','{bcrypt}$2a$10$hf4tGs2s3mPodqpOmSnBNehJ3dm9f1GBaq9lLhdBP7nEM5d89q51e',1), -- StaffPflamoehus1!
(3,'2000-10-10','DIVERSE','warehouse@pflamoehus.de','Warehouse','Pflamoehus', '{bcrypt}$2a$10$tI1brWPJyD0pDgexwwBkKuWmlmn4H6UFgKvhvtsMjnWLIllWgUcjS',1), -- WarehousePfalmoehus1!
(4,'1968-11-01','DIVERSE','service@pflamoehus.de','Service','Pflamoehus','{bcrypt}$2a$10$C.nSMnLuE8INPF0z8Va92eLHEtu9fRWVwA3LKnXXoC.IQQbND/D3S',1); -- ServicePflamoehus1!
