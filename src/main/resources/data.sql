...
(96, 140.5, 'Bettgestell, helles Massivholz, 140x215x60 cm, Preis inkl. MwSt*', 60.0, 'Stilvolle Eleganz kombiniert mit Komfort und Stabilität, das erwartet Sie bei unserem Bett Wild Life. Alle Ecken und Kanten sind gerundet, sodass das Gestell sehr harmonisch wirkt.', 'Wild Life', 17, 117.17, 'BED', 'BEDROOM', 1, 215.0),
...
(98, 120.0, 'Bettgestell, Massivholz, 120x180x40 cm, Preis inkl. MwSt*', 40.0, 'Unser Bett Allrounder erzeugt durch sein attraktives Design ein unvergleichliches Raumflair. Auf Wunsch ist dieses Gestell auch mit einem geradlinigen Kopfteil erhältlich.', 'Allround', 3, 99.99, 'BED', 'BEDROOM', 1, 180.0);      
INSERT INTO PRODUCT(ARTICLENR, DEPTH, DESCRIPTION, HEIGHT, INFORMATION, NAME, AVAILABLE, PRICE, PRODUCTTYPE, ROOM, VERSION, WIDTH) VALUES
...
(102, 50.0, 'Kommode, 6 Schubladen, mint, 120x110x50 cm, Preis inkl. MwSt*', 110.0, 'Mint hat ein schlichtes skandinavisches Design. Neben den lackierten Schubladen fallen vor allem die Füße ins Auge, schließlich heben Sie sich geschickt vom restlichen Design ab.', 'Mint', 117, 500.0, 'CLOSET', 'BEDROOM', 1, 120.0),
(103, 45.0, 'Kleiderschrank, offen, schwarz, 210.30x200x45 cm, Preis inkl. MwSt*', 200.0, 'Das Schwerlastregal zur Wandmontage ist einfach zu montieren. Diese offene Aufbewahrungskombination lässt sich nach Wunsch ergänzen oder verändern.', 'Schwerlastregal', 1300, 1900.99, 'CLOSET', 'BEDROOM', 1, 210.3),
(104, 83.5, 'Kleiderschrank, Glastüren, schwarz, 180x213.60x83.50 cm, Preis inkl. MwSt*', 213.6, 'Justus Business ist ein exklusiver Design Kleiderschrank mit transparenten Glastüren. Der Korpus bestehet aus hochwertigen MDF mit einer porenfreien Kunststoffbeschichtung.', 'Justus Business', 5, 9999.99, 'CLOSET', 'BEDROOM', 1, 180.0),
...
(106, 80.0, 'Tisch, rund, Holz, 80x90x80 cm Preis inkl. MwSt*', 90.0, 'Mit diesem trendigen Esstisch erhalten Sie ein individuelles und einzigartiges Naturprodukt. Integrieren Sie das trendige Möbelstück in rustikale & klassische Einrichtungen.', 'Rund', 111, 110.99, 'TABLE', 'LIVINGROOM', 1, 80.0),
...
(109, 95.0, 'Tisch, Betonoptik/Holz, 180x90x95 cm Preis inkl. MwSt*', 90.0, 'Der Tisch verfügt über ein Gestell und Füße aus Akazienholz und eine robuste Tischplatte aus Betonoptik. Der Tisch bietet einen attraktiven Platz zum gemütlichen Speisen.', 'Lifestail', 25, 110.99, 'TABLE', 'LIVINGROOM', 1, 180.0),
(110, 89.9, 'Tisch, Glasplatte/Holz, 112.80x96x89.90 cm Preis inkl. MwSt*', 96.0, 'Designer-Esstisch aus Glas und Holz. Platte aus gehärtetem Glas mit einer Dicke von 1 cm. Die raffinierten Beine aus Eichenholz sind sehr widerstandsfähig.', 'Alfrede', 89, 110.99, 'TABLE', 'LIVINGROOM', 1, 112.8),
...
(112, 80.0, 'Tisch, Massivholz/Metall, 180x90x80 cm Preis inkl. MwSt*', 90.0, 'Der Esstisch Classic aus Wildeiche hat das perfekte Design für alle Esszimmer, sowie auch für die Küche oder den Wintergarten. Das optische Highlight sind seine schwarzen Füße.', 'Classic', 99, 110.99, 'TABLE', 'LIVINGROOM', 1, 180.0),        
...
(114,60, 'Küche, grau/braun, 141x180x60 cm, Preis inkl. MwSt*', 141, 'Diese Küche kommt ohne Geräte und besteht aus einer oberen und einer unteren Schranksektion. Sie ist perfekt für eine morderne, aber stilvolle Wohnung.','classic Kitchen',11, 8500,'KITCHEN','KITCHEN', 1, 180),
